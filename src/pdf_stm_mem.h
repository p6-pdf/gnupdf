/* -*- mode: C -*- Time-stamp: "07/07/08 21:48:15 jemarch"
 *
 *       File:         pdf_stm_mem.h
...
size_t pdf_stm_mem_read (void *be_data, char *buf, size_t bytes);
size_t pdf_stm_mem_write (void *be_data, char *buf, size_t bytes);
size_t pdf_stm_mem_peek (void *be_data, char *buf, size_t bytes);
