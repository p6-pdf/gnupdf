 ...
 *
 *       GNU PDF Library - Unit tests for pdf_time_span_add
 *
 */
...
/*
 * Test: pdf_time_span_add_001
 * Description:
 *   Create two pdf_time_span_t objects, and check
 *   if the sum of spans is expected one.
 *Success condition:
 * 1. Function pdf_time_span_new schould return PDF_OK
 * 2. Function pdf_time_span_add schould return PDF_OK.
 * 3. Result schould be equal span1+span2
 */
START_TEST (pdf_time_span_add_001)
{
  pdf_status_t status;
  pdf_i64_t sec;
 ...
 * pdf_status_t */
  ...
  fail_if(pdf_i64_cmp_i32(sec,-1) != 0);
...
/*
 * Test: pdf_time_span_add_002
 * Description:
 *  Try to get sum of two pdf_time_span_t objects
 *  into NUL pointing pdf_time_span_t* pointer.
 *Success condition:
 * 1. Function pdf_time_span_new schould return PDF_OK
 * 2. Function pdf_time_span_add schould return PDF_ERROR.
 * 3. Result schould be equal span1+span2
 */
START_TEST (pdf_time_span_add_002)
{
  pdf_status_t status;
  pdf_i64_t sec;
  pdf_time_span_t span1;
 ...
 */
TCase *
test_pdf_time_span_add (void)
{
  TCase *tc = tcase_create ("pdf_time_span_add");

  tcase_add_test(tc, pdf_time_span_add_001);
  tcase_add_test(tc, pdf_time_span_add_002);


  return tc;
}

/* End of pdf-time-span-add.c */
