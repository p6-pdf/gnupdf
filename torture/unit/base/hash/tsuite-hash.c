...
extern TCase *test_pdf_hash_get_value (void);
extern TCase *test_pdf_hash_iterator_init (void);
...
tsuite_hash ()
{
  ...
  suite_add_tcase (s, test_pdf_hash_rename_key ());
  suite_add_tcase (s, test_pdf_hash_iterator_init ());
